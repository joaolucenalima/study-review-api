/*
  ...
  - Added the required column `next_revision_day` to the `Task` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "next_revision_day" TIMESTAMP(3) NOT NULL,
